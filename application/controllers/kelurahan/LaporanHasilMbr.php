...
class LaporanHasilMbr extends CI_Controller{
    ...
    public function HasilMbr($tanggalHitung, $kecamatan = NULL, $kelurahan = NULL)
    {
        ...
        $this->load->view('kelurahan/cetakHasilMbr',$data);
    }
    
    public function HasilMbrPdf($tanggalHitung=NULL, $kecamatan = NULL, $kelurahan=NULL)
    {
        ...
        $this->pdf->load_view('kelurahan/hasilPdfMbr', $data);

    }

    public function HasilMbrExcel($tanggalHitung=NULL, $kecamatan = NULL, $kelurahan=NULL)
    {
