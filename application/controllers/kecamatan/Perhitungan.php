...
class Perhitungan extends CI_Controller{
    ...
    public function index()
    {
        ...
        $mbrs = $this->db->query("SELECT * FROM data_mbr WHERE kecamatan = '$kec' AND DATE_FORMAT(tanggal, '%m-%Y') = '$bulanTahun' ORDER BY nama_mbr ASC")->result();
        ...
        $this->load->view('kecamatan/perhitungan',$data);
